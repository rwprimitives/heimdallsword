...
class EmailClient:
    ...
    def send(self, recipient):
        ...
        error messages are stored in the :py:attr:`heimdallsword.models.recipient.Recipient.delivery_error_message` attribute,
        and the :py:attr:`heimdallsword.models.recipient.Recipient.delivery_state` attribute is set with a constant type from
        :py:class:`heimdallsword.models.recipient.DeliveryState` class.
        ...
        :returns: :py:const:`heimdallsword.models.recipient.DeliveryState.SUCCESSFUL_DELIVERY` on successful delivery of an email
